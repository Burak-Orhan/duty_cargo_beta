...
class TrackingController extends Controller
{
    ...
    public function trackingPost(Request $request)
    {
        ...
        //     ->select("u.name as users_name", "c.tracking_code", "co.name as company_name","co.country as company_country", "co.city as company_city","cu.purchase_date as customer_purchase_date", "co.state as company_state", "co.state as company_state","co.post_date as company_post_date", "cu.purchase_date", "ui.city as users_information_city", "ui.country as users_information_country")
        ...
        $trackingCode = DB::table("users as u")
            ->select(
